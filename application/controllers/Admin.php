...
class Admin extends CI_Controller
{
    ...
    public function registerSiswa()
    {
        ...
        $this->form_validation->set_rules('nama_siswa');
        $this->form_validation->set_rules('nis_siswa');
        $this->form_validation->set_rules('email_siswa');
        $this->form_validation->set_rules('password_siswa');
